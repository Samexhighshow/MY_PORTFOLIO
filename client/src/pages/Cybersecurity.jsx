...
const labTools = [
    { name: "Kali Linux", type: "OS / Pentesting", icon: "terminal" },
    { name: "Wireshark", type: "Network Analysis", icon: "troubleshoot" },
    { name: "Nmap", type: "Network Discovery", icon: "radar" },
    { name: "Burp Suite", type: "Web App Security", icon: "bug_report" },
    { name: "Metasploit", type: "Exploitation", icon: "pest_control" },
    { name: "Snort", type: "Intrusion Detection", icon: "policy" }
];
